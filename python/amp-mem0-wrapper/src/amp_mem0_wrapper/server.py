"""
AMP Mem0 Wrapper — Agent Memory Protocol server wrapping Mem0.
"""
...
def amp_encode(
    ...
    # Save to Mem0 (both platform and local clients share the same add() signature)
    try:
    ...
    # Mem0 add return value: list of items or confirmation dict
    mem_id = None
...
def amp_recall(
    ...
    for item in raw_results:
        # Item may have "memory" or "content"
...
def main():
    parser = argparse.ArgumentParser(description="AMP Mem0 Wrapper Server")
